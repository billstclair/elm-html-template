...
_billstclair$elm_bitwise_infix$BitwiseInfix_ops['~>>>'] = _elm_lang$core$Bitwise$shiftRightLogical;
var _billstclair$elm_bitwise_infix$BitwiseInfix_ops = _billstclair$elm_bitwise_infix$BitwiseInfix_ops || {};
_billstclair$elm_bitwise_infix$BitwiseInfix_ops['~>>'] = _elm_lang$core$Bitwise$shiftRight;
var _billstclair$elm_bitwise_infix$BitwiseInfix_ops = _billstclair$elm_bitwise_infix$BitwiseInfix_ops || {};
_billstclair$elm_bitwise_infix$BitwiseInfix_ops['~<<'] = _elm_lang$core$Bitwise$shiftLeft;
	...
	function (i, index, message, length, blocks) {
		...
		while (true) {
			if (_elm_lang$core$Basics$not(
				(_elm_lang$core$Native_Utils.cmp(index, length) < 0) && (_elm_lang$core$Native_Utils.cmp(i, 64) < 0))) {
...
var _billstclair$elm_sha256$Sha256$extra = _elm_lang$core$Native_List.fromArray(
	[-2147483648, 8388608, 32768, 128]);
var _billstclair$elm_sha256$Sha256$outerLoop = F8(
	function (hs, block, start, bytes, index, is224, message, length) {
		outerLoop:
		while (true) {
			var first = true;
			...
			if (_elm_lang$core$Basics$not(end)) {
				var _v12 = hs3,
					_v13 = block2,
					_v14 = start2,
					_v15 = bytes2,
...
var _billstclair$elm_sha256$Sha256$hash = F2(
	function (string, is224) {
		...
		var hs2 = A8(_billstclair$elm_sha256$Sha256$outerLoop, hs, block, start, bytes, index, is224, message, length);
...
var _billstclair$elm_sha256$Sha256Tests$doDefaultTests = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1._0;
	return A2(
		_elm_lang$core$List$map,
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_p1._1,
				_billstclair$elm_sha256$Sha256$sha256(_p2)),
				A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_p1._2,
				_billstclair$elm_sha256$Sha256$sha224(_p2))
			]));
};
var _billstclair$elm_sha256$Sha256Tests$data = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple3', _0: 'foo', _1: '2c26b46b68ffc68ff99b453c1d30413413422d706483bfa0f98a5e886266e7ae', _2: '0808f64e60d58979fcb676c96ec938270dea42445aeefcd3a4e6f8db'},
		{ctor: '_Tuple3', _0: 'The quick brown fox jumped over the lazy dog.', _1: '68b1282b91de2c054c36629cb8dd447f12f096d3e3c587978dc2248444633483', _2: '0c38eb6c6e803f9fbcd06f006506bde86a7dd84a1b5f098d43d45e56'},
		{ctor: '_Tuple3', _0: 'Four score and seven years ago...', _1: '0d8e421d91346d5680433b294b2ac4cfba46cc8dfb36272af7994216aa781dfb', _2: '4e29b711e9cc0bc8510b43cc61f3bc27f17c7f1a4cf0aab9817937fd'}
	]);
var _billstclair$elm_sha256$Sha256Tests$basicTests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Basic',
	A2(_elm_lang$core$List$concatMap, _billstclair$elm_sha256$Sha256Tests$doDefaultTests, _billstclair$elm_sha256$Sha256Tests$data));
var _billstclair$elm_sha256$Sha256Tests$tests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'sha256',
	_elm_lang$core$Native_List.fromArray(
		[_billstclair$elm_sha256$Sha256Tests$basicTests]));

var _billstclair$elm_sha256$Test$tests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'All',
	_elm_lang$core$Native_List.fromArray(
		[_billstclair$elm_sha256$Sha256Tests$tests]));
var _billstclair$elm_sha256$Test$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_billstclair$elm_sha256$Test$tests)
};

var Elm = {};
Elm['Test'] = Elm['Test'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Test'], 'Test', typeof _billstclair$elm_sha256$Test$main === 'undefined' ? null : _billstclair$elm_sha256$Test$main);
